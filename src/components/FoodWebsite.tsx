...
const FoodWebsite = () => {
  ...
  // Fonction pour retourner à l'animation Gotham
  const returnToGotham = () => {
    window.dispatchEvent(new CustomEvent('gotham-animation-return'));
  };
        ...
        <div className="container">
          <div className="header-content">
            ...
            <div className="header-actions">
              <button onClick={returnToGotham} className="cta-button gotham-return">
                🦇 Retour Gotham
              </button>
